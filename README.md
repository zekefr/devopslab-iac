...
- Proxmox VE (PVE 9.x)
- Ansible (currently: Proxmox host bootstrap, tweaks, and upgrade)
- Terraform (planned)
...
- Implemented: tooling + initial Ansible scope for Proxmox host bootstrap/tweaks/upgrade
...
- `docs/10-proxmox-bootstrap.md` - Proxmox bootstrap/tweaks/upgrade concepts, commands, and troubleshooting
